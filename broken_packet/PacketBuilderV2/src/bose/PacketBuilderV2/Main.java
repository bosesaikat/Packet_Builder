...
import bose.BrokenPacket.BrokenPacketBuilder;
...
public class Main {
   ...
   /*   for(int i = 0 ; i < packetData.size() ; i++ ){
      ...
      */
      // new PacketDeserialize().deSerialize(packetData);
      
      BrokenPacketBuilder brokenPacketBuilder = new BrokenPacketBuilder(attributesInfoList) ;
      brokenPacketBuilder.addAttributes();
      ArrayList<byte[]> packetData = brokenPacketBuilder.getByte();
